    ...
    <div className="mx-auto max-w-3xl px-6 py-16 text-center">
      ...
      <Section title="Путь пользователя">
        <ol className="space-y-4">
          ...
          <Step n={6} title="Форматирование и рендер">
            Чистый, scannable layout → .docx/.pdf.
          </Step>
          <Step n={7} title="Версии">
